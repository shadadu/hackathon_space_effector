...
# from objecttracking.scripts.dgm_model import load_model, DGMValueNet, build_input
...
class DGMRollout:
    ...
    def rollout_dgm_joint_policy(
        ...
        for k in range(N):
            ...
            # clamp velocities
            u = DGMRollout.clamp(u, -cfg.vel_limits, cfg.vel_limits)
            ...
            if k < N - 1:
                q = q + cfg.dt * u
                q = DGMRollout.clamp(q, cfg.joint_min, cfg.joint_max)
